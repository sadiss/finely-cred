...
**[docs/DEVELOPER_GUIDE.md](docs/DEVELOPER_GUIDE.md)** — full-stack runbook for new developers: local setup, env secrets, Supabase migrations, edge functions, CTA routing, growth agents, video/voice studio, live mail, admin view-as, Aug 2026 launch sprint (§15), and platform expansion ship (§16).
