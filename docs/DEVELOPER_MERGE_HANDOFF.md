# Developer merge handoff (docs index)

Quick pointers for non-code deliverables that ship with the product.

## Specialist Academy (trainee curriculum)

**Location:** [`docs/specialist-academy/`](./specialist-academy/README.md)

| Asset | Purpose |
| --- | --- |
| [README](./specialist-academy/README.md) | Pack map, tracks, how to use |
| [TRACK F (EN)](./specialist-academy/TRACK-F-credit-methodology-EN.md) | Full credit methodology — Finely restore practice |
