...
export const STAFF_ROSTER_EXPANSION: StaffMember[] = [
  mx('staff-kenya-wells', 'Kenya', 'Wells', 'debt_strategist', 'debt_resolution', 'feminine', 'Bankruptcy Chapter 7/13 filing coach — means test and petition schedules.', 'Bankruptcy Filing Specialist', [WEEKDAY, EARLY]),
  mx('staff-darnell-price', 'Darnell', 'Price', 'debt_strategist', 'debt_resolution', 'masculine', 'Foreclosure defense — automatic stay and sale-date emergencies.', 'Foreclosure Stay Advocate', [WEEKDAY, EVENING]),
  ...
  mx('staff-terrence-floyd', 'Terrence', 'Floyd', 'debt_strategist', 'debt_resolution', 'masculine', 'Court summons and affidavit strategy — civil procedure education.', 'Court & Summons Specialist', [WEEKDAY, LATE]),
  mx('staff-monique-baker', 'Monique', 'Baker', 'debt_strategist', 'debt_resolution', 'feminine', 'FDCPA validation and collection proof demands.', 'Validation & FDCPA Specialist', [EARLY, WEEKDAY]),
  ...
  mx('staff-andre-coleman', 'Andre', 'Coleman', 'debt_strategist', 'debt_resolution', 'masculine', 'Business Chapter 11 reorganization educational support.', 'Business Bankruptcy Advisor', [WEEKDAY, LATE]),
  ...
  mx('staff-derek-hughes', 'Derek', 'Hughes', 'dispute_coach', 'dispute_processing', 'masculine', 'Experian bureau dispute — factual reason library.', 'Experian Dispute Specialist', [WEEKDAY, EARLY]),
  ...
  mx('staff-malcolm-grant', 'Malcolm', 'Grant', 'dispute_coach', 'dispute_processing', 'masculine', 'Metro 2 field accuracy and furnisher disputes.', 'Metro 2 Accuracy Specialist', [LATE]),
  ...
  mx('staff-cedric-powell', 'Cedric', 'Powell', 'dispute_coach', 'dispute_processing', 'masculine', 'Charge-off and collection tradeline disputes.', 'Collection Tradeline Specialist', [WEEKDAY, EVENING]),
  ...
  mx('staff-keisha-porter', 'Keisha', 'Porter', 'funding_strategist', 'funding', 'feminine', 'Funding readiness and underwriting prep.', 'Funding Readiness Coach', [WEEKDAY, EARLY]),
  ...
  mx('staff-travis-wright', 'Travis', 'Wright', 'sales_closer', 'growth_sessions', 'masculine', 'DIY vs DFY consult fit and ethical close.', 'Solutions Advisor', [WEEKDAY, EVENING]),
  ...
  mx('staff-amber-johnson', 'Amber', 'Johnson', 'support_specialist', 'partner_success', 'feminine', 'Communication Hub and thread routing.', 'Hub Support Specialist', [WEEKDAY, LATE]),
  ...
  mx('staff-patricia-owen', 'Patricia', 'Owen', 'letter_ops_agent', 'dispute_processing', 'feminine', 'Certified mail prep and letter QA.', 'Letter Operations Specialist', [WEEKDAY, EARLY]),
  ...
  mx('staff-gina-torres', 'Gina', 'Torres', 'crm_intake_specialist', 'internal_ops', 'feminine', 'CRM intake, scoring, and lead routing.', 'CRM Intake Specialist', [WEEKDAY, EVENING]),
  mx('staff-donovan-price', 'Donovan', 'Price', 'processing_agent', 'dispute_processing', 'masculine', 'Bureau response triage and round timelines.', 'Processing Agent', [LATE]),
];
