    ...
    <section className="rounded-2xl border border-[#fbbf24]/30 bg-gradient-to-br from-[#0b1110] to-[#060908] p-6 sm:p-8">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
        ...
        <Link to="/admin/marketing/growth-acquisition/social" className={BTN}>
          ...
          <span className="text-xl font-bold text-white">B · Post (Social Media)</span>
          <span className="text-sm text-white/70">Facebook & YouTube — Day 1–7 captions + calendar.</span>
        </Link>
        <Link to="/admin/marketing/growth-acquisition/content" className={BTN}>
          <FileText className="text-[#fbbf24]" size={32} />
          <span className="text-xl font-bold text-white">C · Guides & one-sheets</span>
          <span className="text-sm text-white/70">HTML handouts and partner verticals.</span>
        </Link>
        <Link to="/admin/marketing/growth-acquisition/email" className={BTN}>
          <Mail className="text-[#fbbf24]" size={32} />
          <span className="text-xl font-bold text-white">D · 21-day email</span>
        ...
        <Link to="/admin/marketing/view/start-restore-147" className={BTN}>
          ...
          <span className="text-xl font-bold text-white">E · $147 Start Restore</span>
        ...
        <Link to="/admin/marketing/partner-referral/content" className={BTN}>
          <FileText className="text-[#fbbf24]" size={32} />
          <span className="text-xl font-bold text-white">F · Partner one-sheets</span>
