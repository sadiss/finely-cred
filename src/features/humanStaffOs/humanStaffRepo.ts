    ...
    threads: [
      {
        ...
        createdAt: nowIso(),
        updatedAt: nowIso(),
        title: 'Lead discovery ownership reset',
        missionType: 'deep_swarm',
        status: 'open',
        cityIds: ['dallas', 'houston'],
        assignedAgentIds: ['pipeline_titan', 'scout_supreme', 'switchboard'],
        summary: 'Clarify that lead discovery is a system process owned by Lead Intel staff and Automation Ops.',
    ...
    memories: [
      {
        ...
        detail: 'The operator wants hierarchy, staff identity, and less mystery around lead discovery and practice mode.',
        source: 'user_note',
        importance: 5,
      },
    ],
