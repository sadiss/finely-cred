...
const CATEGORY_PLAYBOOKS: Record<PricingCategory, SeedSpec[]> = {
  personal_credit: [
    ...
    { slug: 'personal_dfy_qc', title: 'DFY quality check before client send', kind: 'review_results', stage: 'disputes', dueDaysOffset: 4, delivery: 'DFY', assignedTo: 'admin', visibility: 'admin' },
    { slug: 'personal_hybrid_review', title: 'Hybrid check-in: client vs ops split', kind: 'follow_up', stage: 'disputes', dueDaysOffset: 7, delivery: 'HYBRID' },
  ...
  business_credit: [
    ...
    { slug: 'biz_hybrid_ops', title: 'Ops prepares vendor list for client approval', kind: 'review_results', stage: 'funding', dueDaysOffset: 7, delivery: 'HYBRID' },
  ...
  wealth_builder: [
    ...
    { slug: 'wealth_dfy_plan', title: 'DFY wealth plan draft + client review', kind: 'review_results', stage: 'intake', dueDaysOffset: 5, delivery: 'DFY' },
  ...
  bundle: [
    ...
    { slug: 'bundle_client_summary', title: 'Client-facing bundle progress summary', kind: 'general', stage: 'funding', dueDaysOffset: 14, visibility: 'hybrid' },
    ...
    { slug: 'bundle_hybrid_sync', title: 'Hybrid sync — ops + client lanes', kind: 'follow_up', stage: 'reports', dueDaysOffset: 7, delivery: 'HYBRID' },
  ],
  tradeline_promo: [
    { slug: 'tradeline_eligibility', title: 'AU tradeline eligibility review', kind: 'review_results', stage: 'funding', dueDaysOffset: 1 },
    { slug: 'tradeline_match', title: 'Match inventory to client profile', kind: 'review_results', stage: 'funding', dueDaysOffset: 2 },
    ...
    { slug: 'tradeline_client_ack', title: 'Client acknowledges AU terms', kind: 'upload_document', stage: 'intake', dueDaysOffset: 0 },
...
const EDGE_PLAYBOOKS: Array<{ category: PricingCategory; spec: SeedSpec }> = [
  ...
  { category: 'bundle', spec: { slug: 'edge_client_ghost', title: 'Client idle 7d — re-engagement playbook', kind: 'follow_up', stage: 'intake', dueDaysOffset: 7, delivery: 'DFY', assignedTo: 'admin' } },
