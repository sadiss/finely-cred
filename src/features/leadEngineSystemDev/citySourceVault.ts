...
export const LEAD_ENGINE_SOURCE_PLANS: LeadEngineSourcePlan[] = [
  ...
  { id: 'chamber_directory', label: 'Chamber Directory Partner Discovery', enabledByDefault: true, officialOnly: false, dailyBudgetCents: 0, maxJobsPerHour: 6, maxResultsPerJob: 15, routingHint: ['agency_partner_recruiting', 'affiliate_partner_recruiting'], complianceNote: 'Directory-level public business data; respectful rate limits.' },
