...
const REAL_SURFACES: Record<string, SurfaceLoader> = {
  ...
  'partner:news': () => import('./partner/PartnerNewsProductSurface'),
  'partner:haitian': () => import('./partner/PartnerHaitianDeskProductSurface'),
  'partner:maintenance': () => import('./partner/PartnerMaintenanceProductSurface'),
  ...
  'admin:ebook-conversions': () => import('./admin/AdminLeftoverWorkstationsSurface'),
  'admin:partner-library': () => import('./admin/AdminLeftoverWorkstationsSurface'),
  ...
  'admin:data-feeds': () => import('./admin/AdminDataFeedsProductSurface'),
  'admin:haitian': () => import('./admin/AdminHaitianCommunityProductSurface'),
  'admin:today': () => import('./admin/AdminTodayProductSurface'),
