...
import { INSPECTOR_CATEGORY_TABS } from './adminSettingsInspectorTabs.tsx';
          ...
          {activeTab === 'home' && (
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-4">
                {INSPECTOR_CATEGORY_TABS.map((t, idx) => (
                  <button key={t.key} type="button" onClick={() => onSelectTab(t.key)} className={`${finelyOsCatalogCard((['emerald', 'violet', 'sky', 'rose'] as const)[idx % 4])} w-full text-left transition-all hover:brightness-[1.02]`} data-fc-accent={(['emerald', 'violet', 'sky', 'rose'] as const)[idx % 4]}>
                ...
                <div className="space-y-4">
                  ...
                  <div className={`${finelyOsCatalogCard('sky')} fc-surface-harmony text-xs ${FINELY_OS_ENTITY_BODY}`}>
                    ...
                    {settings.features.letterMailing ? (
                      ...
                      <span className={`${FINELY_OS_ENTITY_SUBLABEL} normal-case tracking-normal`}>
                        Off — letter studio hides physical mail actions
                      </span>
                    )}
                  </div>
                        ...
                        <td className={`py-3 pr-4 ${FINELY_OS_ENTITY_VALUE}`}>
                          ...
                          <div className={`mt-1 font-mono text-[10px] ${FINELY_OS_ENTITY_SUBLABEL}`}>
                            ...
                            {settings.features[row.flag] ? (
                              ...
                              <span className={`ml-2 ${FINELY_OS_ENTITY_SUBLABEL} normal-case tracking-normal`}>off</span>
                            )}
                          </div>
                        </td>
                ...
                <div className={`${finelyOsCatalogCard('sky')} fc-surface-harmony`} data-fc-accent="sky">
                  ...
                  <ul className={`mt-2 space-y-1 font-mono text-sm ${FINELY_OS_ENTITY_BODY}`}>
                    {bootstrapAdminEmails.length ? (
                      ...
                      <li className={FINELY_OS_ENTITY_SUBLABEL}>None configured</li>
                    )}
                  </ul>
                </div>
                      ...
                      (((settings as any).security?.adminEmails ?? []) as string[]).map((e) => (
                        ...
                        >
                          ...
                          <button
                            ...
                            className={`${FINELY_OS_ENTITY_SUBLABEL} normal-case tracking-normal hover:text-rose-600`}
                            title="Remove"
                          >
                            <Trash2 size={14} />
                          </button>
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <button
                                  ...
                                  className={`px-3 py-2 rounded-xl border text-[10px] font-black uppercase tracking-widest transition-all ${
                                    s.disabled
                                      ? `${FINELY_OS_SECONDARY_BTN} ${FINELY_OS_ENTITY_SUBLABEL} normal-case tracking-normal`
          ...
          {activeTab === 'customFields' && (
            <div className="space-y-6">
              ...
              <div className={`${finelyOsCatalogCard('violet')} space-y-3`}>
                ...
                <p className={FINELY_OS_ENTITY_BODY}>
                  Saved field definitions and layouts appear on partner, case, and project detail screens for your team.
                </p>
              </div>
            </div>
          )}
