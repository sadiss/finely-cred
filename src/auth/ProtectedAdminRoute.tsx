    ...
    return (
      ...
      >
        <div className="space-y-4">
          <div className="rounded-2xl border border-white/[0.08] bg-white/[0.07] backdrop-blur-xl p-6 text-white/60 text-sm">
          ...
          {membership ? (
            <div className="rounded-2xl border border-white/[0.08] bg-white/[0.03] p-6 text-white/70 text-sm">
