  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: 'f-fcra-doctrine',
        track: 'F',
        title: 'FCRA investigation doctrine',
        pathEn: p('lessons/en/10-fcra-investigation-doctrine.md'),
        minutes: 32,
      },
      {
        id: 'f-fdcpa-honesty',
        track: 'F',
        title: 'FDCPA validation honesty',
        pathEn: p('lessons/en/11-fdcpa-collection-honesty.md'),
        minutes: 28,
      },
      {
        id: 'f-metro2-factual',
        track: 'F',
        title: 'Metro 2 factual disputes',
        pathEn: p('lessons/en/12-metro2-factual-disputes.md'),
        minutes: 30,
      },
      {
        id: 'f-fico-honesty',
        track: 'F',
        title: 'FICO & score model honesty',
        pathEn: p('lessons/en/13-fico-score-model-honesty.md'),
        minutes: 26,
      },
      {
        id: 'f-track-en',
