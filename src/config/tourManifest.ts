...
export const TOUR_MANIFEST: SiteTourDefinition[] = [
  ...
  },
  {
    ...
    title: 'How to open a client file',
    lane: 'admin',
    auth: 'admin',
    startPath: '/admin/partners',
    relatedSopId: 'sop-admin-create-partner',
    steps: [
      step('s1', 'Partner list', 'All clients appear in Partner Management.', '/admin/partners'),
      step('s2', 'Click a card', 'Click the client name to open their full file.', '/admin/partners'),
  ...
  },
  {
    ...
    steps: [
      ...
      step('s2', 'Client dashboard', 'Open the partner dashboard for your assigned client.', '/portal/dashboard'),
