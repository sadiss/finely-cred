...
export const FINELY_WOW_CHIPS: FinelyWowChip[] = [
  {
    ...
    hint: 'Guides open Letter Studio, task board, and vault — not PDF-only',
    path: '/free-guide',
    accent: 'emerald',
  },
  {
    id: 'fight-back-debt',
    label: 'Fight-back debt lane',
    hint: 'Validation-first pressure response when collectors or courts move',
  ...
  },
  {
    ...
    hint: 'Certified-mail workflow with document vault in one OS',
    path: '/free-guide',
    accent: 'violet',
  },
];
