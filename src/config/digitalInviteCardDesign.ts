...
export const DIGITAL_INVITE_CARD_DESIGNS: Record<DigitalInviteCardRole, DigitalInviteDesign> = {
  ...
  au_seller: {
    ...
    eyebrow: 'Supply-side · AU',
    roleTitle: 'AU',
    roleTitleSub: 'Seller',
    titleSize: 82,
    qrSize: 200,
    valueProp: 'You supply the cards. Finely markets to buyers and pays you on every verified placement.',
    monogram: 'AU',
    sealCaption: 'AU Seller Access',
    proofPoints: ['Verified add tracking', 'Payouts from 35%', 'Compliance-reviewed listings'],
    qrCue: 'Join via this invite',
    qrSubCue: 'Scan to open the AU seller page',
