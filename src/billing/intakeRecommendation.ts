...
/**
 * Rules-based mock recommendation engine.
 * Maps intake data to a recommended product tier.
 * In production, this could call an AI model or more sophisticated rules.
 */
