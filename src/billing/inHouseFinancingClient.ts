...
/**
 * Phase 2 scaffold:
 * - This is the "in-house financing" rail client (Denefits later).
 * - UI must never mention Denefits branding.
 * - Today we keep a local mock store so the orchestration layer can be built end-to-end.
 */
