...
export const CREDIT_FUNNEL: LeadMagnetFunnelConfig = {
  ...
  metaDesc: 'Download the dispute letter guide and open live Letter Studio, task board, and partner portal preview.',
  urgencyText: '⚡ ACT NOW — Free dispute toolkit + live portal trial (limited weekly access)',
  heroHeadline: 'Stop guessing.',
  heroHighlight: 'Start disputing',
  heroSub: 'with live tools — not PDF-only.',
  valueStack: [
  ...
  features: [
    ...
    { icon: LayoutDashboard, title: `${LEAD_MAGNET_TRIAL_DAYS}-day live portal trial`, desc: 'Upload a report, run Letter Studio, and preview the real task board.' },
...
export const DEBT_FUNNEL: LeadMagnetFunnelConfig = {
  ...
  metaDesc: 'Fight-back collections playbook — FDCPA validation, summons triage, and live debt lane portal.',
  urgencyText: 'FREE — Fight-back validation playbook + strategist session',
  heroHeadline: 'Fight back with',
  ...
  features: [
    { icon: ShieldCheck, title: 'Fight-back validation', desc: 'FDCPA-aware letters that force proof before you pay.' },
