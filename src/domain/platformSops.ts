...
export const PLATFORM_SOP_LIBRARY: PlatformSop[] = [
  ...
  {
    id: 'sop-portal-restore-workspace',
    title: 'Walk the Personal Credit Restore sequence',
    lane: 'portal',
    audience: 'partner',
    whenToUse: 'Partner wants the full restore path — reports through letter vault — in one guided station.',
    ownerRole: 'dispute_coach',
    steps: [
      { order: 1, label: 'Upload credit report', detail: 'HTML export parses tradelines and payment history best.', route: '/portal/reports' },
      { order: 2, label: 'Review findings', detail: 'Confirm negatives in Credit Intelligence before disputing.', route: '/portal/reports' },
      { order: 3, label: 'Capture bureau screenshots', detail: 'Save one clean crop per bureau per negative into Evidence Vault.', route: '/portal/analysis' },
      { order: 4, label: 'Open dispute cases', detail: 'Track bureau rounds with factual, screenshot-backed findings.', route: '/portal/disputes' },
      { order: 5, label: 'Generate credit letters', detail: 'Attach exhibits and reasons in Letter Studio.', route: '/portal/letters' },
      { order: 6, label: 'Mail and log vault', detail: 'Certified mail proof and response windows live in Letter Vault.', route: '/portal/letters/vault' },
      { order: 7, label: 'Complete follow-ups', detail: 'Clear mail and bureau deadline tasks quickly.', route: '/portal/projects' },
    ],
    relatedRoutes: ['/portal/checklist', '/preview/workspace-light/portal/checklist'],
    relatedTourId: 'tour-portal-upload-report',
    checklistItems: [
      'Report uploaded and parsed',
      'Screenshot proof linked to tradelines',
      'Dispute case active',
      'Letter generated and mailed',
    ],
  },
  {
