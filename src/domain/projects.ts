...
export type Project = {
  ...
  notes: ProjectNote[];
  /** Measurable outcomes this project drives toward (Phase 13). */
  outcomes?: import('./workResults').ProjectOutcome[];
  /** Cached KPI snapshot — refreshed on task/outcome changes. */
  kpis?: import('./workResults').ProjectKpi;
  createdAt: string;
  updatedAt: string;
  /** Who can see this project in portal vs admin-only ops boards. */
