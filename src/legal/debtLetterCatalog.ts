...
const COURT: DebtLetterCatalogEntry[] = [
  ...
  v('court', 'affidavit_dispute', 'Affidavit', 'Sworn affidavit of dispute — formal affidavit text only.', ['Pre-trial', 'MSJ response'], ['Evidence rules'], 'Put facts under oath.', ['summons_served'], 'full', 'affidavit_of_dispute'),
