...
const COURT: DebtLetterCatalogEntry[] = [
  ...
  v('court', 'courtroom_written_answer', 'Court answer letter', 'Complete written answer + certificate of service — formal pleading only.', ['Summons served'], ['Civil procedure'], 'Do not admit facts you cannot honestly state.', ['summons_served'], 'full', 'courtroom_written_answer'),
  v('court', 'courtroom_day_kit', 'Court-day prep kit (UI only)', 'Hearing scripts and checklist on-screen — never a mailed letter.', ['Trial or hearing scheduled'], ['Evidence', 'Civil procedure'], 'Stick to truthful facts and missing proof.', ['summons_served'], 'full', 'courtroom_day_kit'),
  v('court', 'affidavit_dispute', 'Response Affidavit', 'Sworn response affidavit of dispute — formal affidavit text only.', ['Pre-trial', 'MSJ response'], ['Evidence rules'], 'Put facts under oath.', ['summons_served'], 'full', 'affidavit_of_dispute'),
