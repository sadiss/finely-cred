...
import { routeProcessedDocument } from './routeProcessedDocument';
import type { DocumentRouteResult } from './routeProcessedDocument';
...
export async function processUploadedDocument(args: {
  ...
  // Route document to Debt Center, Disputes, Identity, etc.
  const routing = routeProcessedDocument({
    partnerId: args.partnerId,
