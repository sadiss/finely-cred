/** Rich editorial copy for premium credit analysis PDF — Finely Cred partner voice. */

export const COMPLIANCE_LINE =
  'Results vary · not legal advice · funding subject to underwriting · educational strategy support only.';

/** How the analysis system works — used in PDF appendix + portal option cards. */
export const ANALYSIS_SYSTEM_HOW_IT_WORKS = {
  title: 'How this analysis system works',
  subtitle: 'Three engines. One goal: a clear next move for your file.',
  paragraphs: [
    'Finely Cred turns your uploaded bureau report into a partner strategy dossier. We parse tradelines, score readiness, rank negatives by leverage, and write a restore → build → fundability sequence you can execute in the portal.',
    'Structured premium (default) builds a full ivory/forest PDF with mindset framing, category negatives, and a ranked action plan. Premium spreads use designed visual boards with live overlays for sessions. Legacy text is reserved for exhibit-heavy appendix runs.',
    'Regenerate after each meaningful update — new report upload, bureau responses, or settled items — so the dossier matches the file you are working from today. Results vary · not legal advice · funding subject to underwriting.',
  ],
  steps: [
    'Upload a fresh bureau report in Reports.',
    'Choose Structured premium (recommended) unless you need visual spreads or legacy exhibits.',
    'Create the analysis — it saves to Strategy reports and your Analysis vault.',
    'Execute priority disputes in Credit Letters → Bureaus; re-upload when responses post.',
  ],
};

export const MINDSET_INTRO = {
  title: 'Credit is a system — not a score',
  subtitle:
    'Before we walk your file, lock the frame: this report is a control map. Your score is one readout. Your tradelines, utilization, inquiries, and negatives are the levers that move approvals, pricing, and fundability.',
  paragraphs: [
    'Most adults were never taught credit as infrastructure. They were taught to pay bills and hope. That is why strong income can sit beside a bruised file — and why a “decent” score can still cap you below the products and capital you are ready for.',
    'At Finely Cred we sort partners into three operating levels. Not to judge — to orient. Once you see the level you have been living in, the items on your report stop feeling random. They become sequenced moves.',
    'We place this section before negatives on purpose. Your file is not a list of failures. It is a picture of where you have been operating — and what becomes possible when the file is engineered with intention. Results vary · not legal advice.',
  ],
};
...
export const MINDSET_TIERS_EXTENDED = [
  {
    ...
    paragraphs: [
      ...
      'Partners here often have solid jobs and real responsibilities, but no credit strategy. Accounts age without plan. Utilization drifts. Old items linger because nobody showed the sequence to remove, validate, or reframe them.',
      'If this sounds familiar, you are not behind — you are uncoached. The gap is not discipline. It is structure, evidence, and a portal that keeps every round auditable.',
    ],
  },
  {
    level: 'Level 02',
    ...
    paragraphs: [
      ...
      'Many partners sit here for years without realizing how close they are to a different tier of access — not because income changed, but because the file never got the same attention as the career.',
    ],
  },
  {
    level: 'Level 03',
    ...
    paragraphs: [
      ...
      'You do not need to be wealthy to think at this level. You need clarity, sequence, and a file that tells the story funders want to underwrite. Results vary · funding subject to underwriting.',
    ],
  },
] as const;
...
export const BLACK_CARD_ESSAY = {
  ...
  paragraphs: [
    ...
    'Ultra-high limits, metal tiers, concierge lanes, and relationship pricing are not marketed to everyone. They are extended to profiles that signal stability, low friction, and long-term value. Underwriters read your tradelines, utilization patterns, inquiry cadence, and negative history as a single narrative.',
    'When that narrative is cluttered — collections that should have been validated, duplicate entries, stale charge-offs, identity inconsistencies — you are not only fighting denials. You are invisible to the tier that would change your terms.',
    'We say this plainly: not knowing your ceiling is often the most expensive line item on your report. You may be one disciplined restore cycle away from a file that qualifies for a different conversation with lenders and funding partners.',
    'This report is designed to show you that ceiling. Not with hype — with sequence. Restore what should not remain. Protect what is working. Build depth where it matters. Then pursue fundability — personally or in business — from strength instead of hope. Results vary · not legal advice.',
  ],
};
...
export const PATH_FORWARD_ESSAY = {
  ...
  intro: [
    'Jumping straight to new applications is the most common mistake we correct. Lenders and underwriters read the whole file, not just the score. This plan respects that reality.',
    'Each phase below has a job. Skipping restore to chase a card is how inquiries stack on top of negatives. Skipping build to chase funding is how approvals arrive with weak limits. The sequence protects you — and protects your optionality.',
  ],
  restore: {
  ...
  fundability: {
    ...
    paragraphs: [
      ...
      'This is the tier where credit stops being a monthly bill and starts being a capital tool — if the file underneath it is engineered to support the story you tell. Funding subject to underwriting · results vary.',
    ],
  },
};
...
export const NEGATIVE_SECTION_INTRO = {
  ...
  paragraphs: [
    ...
    'Items marked for dispute in your portal may appear here with strategist notes. Your uploaded bureau report remains the source of record for line-by-line history. Results vary · not legal advice.',
  ],
};
...
export const PRIORITY_SECTION_INTRO = {
  ...
  paragraphs: [
    'Below are your highest-leverage targets based on the parsed report and dispute intelligence in Finely Cred. Each item includes why it ranks where it does — factual findings from your bureau export, not procedural filler.',
    'Work one tradeline per letter. Log mail dates. Upload responses. Re-run analysis when the bureaus update. That loop is the job — we built the portal to hold it in one place. Results vary · not legal advice.',
  ],
};
...
export const ROADMAP_ESSAY = {
  ...
  paragraphs: [
    ...
    'Treat each window as a checkpoint, not a deadline. Credit rewards documentation and patience more than volume. Results vary · not legal advice.',
  ],
};
...
export const FINELY_PARTNERSHIP = {
  ...
  paragraphs: [
    ...
    'When fundability is the goal, Nora Capital Group (NCG) underwriting may enter after readiness gates are met — funding subject to underwriting. Results vary · not legal advice.',
  ],
};
...
export const CLOSING_ESSAY = {
  ...
  paragraphs: [
    ...
    'When updates post — typically 30 to 45 days after a dispute round — upload fresh reports. We will measure movement, adjust the plan, and tell you whether you are ready to build or pursue fundability.',
    ...
    'Re-open Reports → select this bureau file → Create premium analysis again after major updates. Your Analysis vault keeps prior versions so you can compare rounds.',
    'This document is educational strategy support — not legal advice, not a guarantee of outcomes. Results vary · funding subject to underwriting. Your situation is unique; your strategist helps you apply this plan to your goals.',
    'A file engineered with intention is one of the highest-return projects you can run this year — and you do not have to run it alone.',
  ],
};
