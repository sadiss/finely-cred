...
const REGISTRY: CoOwnerExecutionEntry[] = [
  ...
  { executeKey: 'affiliate_residual', label: 'Affiliate residual', domain: 'revenue', description: 'Commission accrual + payout readiness', handlerKind: 'data_action', schedule: 'weekly', navigateTo: '/admin/affiliates' },
  { executeKey: 'route_comms', label: 'Comms routing', domain: 'comms', description: 'Partner message routing audit', handlerKind: 'data_action', navigateTo: '/admin/comms' },
  { executeKey: 'course_build', label: 'Course builder', domain: 'training', description: 'Training Academy module proposal', handlerKind: 'data_action', navigateTo: '/admin/training-academy' },
