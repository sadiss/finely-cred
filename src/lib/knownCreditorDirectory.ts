...
export const KNOWN_CREDITOR_DIRECTORY: KnownCreditorEntry[] = [
  ...
  {
    aliases: ['affirm', 'affirm inc'],
    displayName: 'Affirm, Inc.',
    address: '650 California St, Floor 12\nSan Francisco, CA 94108',
    phone: '855-423-3729',
    kind: 'bank',
  },
  {
    aliases: ['wells fargo', 'wells fargo card serv', 'wf card services'],
    displayName: 'Wells Fargo Card Services',
    address: 'P.O. Box 10347\nDes Moines, IA 50306',
    phone: '800-642-4720',
    kind: 'bank',
  },
  {
    aliases: ['barclays', 'barclays bank delaware', 'barclaycard'],
  ...
  {
    aliases: ['easternbk', 'eastern bank'],
