...
export const PUBLIC_ROUTES: RouteSpec[] = [
  ...
  { path: '/pricing/business-credit', title: 'Business Credit', badge: 'Public' },
  { path: '/pricing/debt-legal', title: 'Debt and legal', badge: 'Public' },
  { path: '/preview/workspace-light', title: 'Light Workspace Preview', badge: 'Admin' },
  { path: '/preview/workspace-light/admin/dashboard', title: 'Admin Dashboard (Light Preview)', badge: 'Admin' },
  { path: '/preview/workspace-light/portal/dashboard', title: 'Partner Dashboard (Light Preview)', badge: 'Admin' },
  ...
  { path: '/resources', title: 'Resource hub', badge: 'Public', subtitle: 'Curated overview cards to dedicated resource pages.' },
  { path: '/resources/guides', title: 'Free guides index', badge: 'Public', subtitle: 'All free funnels and PDF field guides.' },
  { path: '/resources/one-sheets', title: 'Partner one-sheets hub', badge: 'Public' },
  { path: '/resources/credit-monitoring', title: 'Credit monitoring', badge: 'Public' },
  { path: '/resources/videos', title: 'Video library', badge: 'Public' },
  { path: '/resources/references', title: 'Quick references', badge: 'Public' },
  {
    path: '/resources/business-credit-one-sheets',
    title: 'Business Credit Partner One-Sheets',
    badge: 'Public',
    subtitle: 'The 3-sheet Process Brief plus premium PDF one-sheets for Foundation → Empire, compare, and named-cards path.',
  },
  {
    path: '/resources/personal-credit-restore-sheet',
    title: 'Personal Credit Restore — 3-Sheet Field Kit',
    badge: 'Public',
    subtitle: 'Rights you invoke, round-one sequence, escalation ladder, and a 90-day hold plan.',
  },
  {
    path: '/resources/personal-credit-build-sheet',
    title: 'Personal Credit Build — 2-Sheet Blueprint',
    badge: 'Public',
    subtitle: 'Five-rung instrument ladder, scoring weights, utilization math, and a 12-month calendar.',
  },
  {
    path: '/resources/au-teen-credit-sheet',
    title: 'Authorized User & Teen Credit — 2-Sheet Parent Kit',
    badge: 'Public',
    subtitle: 'Issuer minimum ages, minor-AU reporting reality, parent checklist, and the 18th-birthday handoff.',
  },
  { path: '/guides', title: 'Guides (alias)', badge: 'Public' },
  { path: '/one-sheets', title: 'One-sheets (alias)', badge: 'Public' },
  { path: '/partner-stories', title: 'Partner stories (alias)', badge: 'Public' },
  ...
  { path: '/pricing/personal-credit-restore', title: 'Personal restore', badge: 'Public', subtitle: 'Dispute what the bureaus show, then sequence the next round.' },
  { path: '/pricing/wealth-builder', title: 'Wealth builder', badge: 'Public', subtitle: 'Credit, company file, and capital in sequence.' },
...
export const PORTAL_PERSONAL_ROUTES: RouteSpec[] = [
  ...
  { path: '/portal/bankruptcy', title: 'Bankruptcy Center', badge: 'Partner Portal' },
...
export const ADMIN_ROUTES: RouteSpec[] = [
  ...
  { path: '/admin/marketing', title: 'Marketing Department', badge: 'Admin' },
  { path: '/admin/marketing-desk', title: 'Marketing Desk', badge: 'Admin' },
  { path: '/admin/growth-agents', title: 'Marketing team · specialist', badge: 'Admin' },
  ...
  { path: '/admin/content-studio', title: 'Content Studio · Video', badge: 'Admin' },
  ...
  { path: '/admin/preview', title: 'Layout Previews', badge: 'Admin' },
  { path: '/admin/preview/dashboard-ivory', title: 'Dashboard Layout Preview', badge: 'Admin' },
  { path: '/admin/preview/marketing-desk-ivory', title: 'Marketing Desk Layout Preview', badge: 'Admin' },
  { path: '/admin/preview/leads-ivory', title: 'Leads Layout Preview', badge: 'Admin' },
  { path: '/admin/preview/crm-ivory', title: 'CRM Layout Preview', badge: 'Admin' },
  { path: '/admin/preview/pricing-ivory', title: 'Pricing Layout Preview', badge: 'Admin' },
  ...
  { path: '/admin/support', title: 'Partner conversations', badge: 'Admin' },
