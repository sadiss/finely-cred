...
export const PUBLIC_ROUTES: RouteSpec[] = [
  ...
  { path: '/agents', title: 'Agent Program', badge: 'Public' },
...
export const PORTAL_PERSONAL_ROUTES: RouteSpec[] = [
  ...
  { path: '/portal/letters', title: 'Letters Command Center', badge: 'Partner Portal' },
  { path: '/portal/letters/vault', title: 'Letters Vault', badge: 'Partner Portal' },
  { path: '/portal/tasks', title: 'Tasks & Notifications', badge: 'Partner Portal' },
  { path: '/portal/messages', title: 'Messages & Support', badge: 'Partner Portal' },
  { path: '/portal/calendar', title: 'Calendar & Enlightenment Sessions', badge: 'Partner Portal' },
  { path: '/portal/projects', title: 'Projects', badge: 'Partner Portal' },
...
export const PORTAL_BUSINESS_ROUTES: RouteSpec[] = [
  ...
  { path: '/business/funding', title: 'Business Funding Readiness', badge: 'Business Portal' },
...
export const ADMIN_ROUTES: RouteSpec[] = [
  ...
  { path: '/admin/ops-agent', title: 'Co‑Owner Ops Agent', badge: 'Admin' },
