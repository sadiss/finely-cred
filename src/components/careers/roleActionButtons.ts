 ...
 * specialist = holographic capsule, agency = gold plate, AU seller = emerald tab.
 */
...
const JOIN_BTN: Record<RolePageId, string> = {
  ...
  au_seller: `${BASE} rounded-l-2xl rounded-r-md border-r-[6px] border-r-emerald-200 bg-[linear-gradient(100deg,#34d399,#059669_60%,#10b981)] px-6 py-3 text-[12px] font-black uppercase tracking-[0.18em] text-[#03211a] shadow-[0_18px_44px_-22px_rgba(16,185,129,0.9)] hover:brightness-105 hover:border-r-white`,
};
...
const SECONDARY_BTN: Record<RolePageId, string> = {
  ...
  au_seller: `${BASE} rounded-l-2xl rounded-r-md border border-emerald-300/35 bg-emerald-400/[0.07] px-5 py-2.5 text-[11px] font-bold uppercase tracking-[0.16em] text-emerald-100 hover:bg-emerald-400/[0.14]`,
};
...
export const ROLE_ACTION_LEGEND: Record<RolePageId, string> = {
  ...
  au_seller: 'Emerald tab = start seller signup · outlined tab = free AU guide · ghost = marketplace links',
};
