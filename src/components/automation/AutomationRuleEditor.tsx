...
export function AutomationRuleEditor({
  ...
  return (
    <div className="fc-light-glass-panel fc-light-chrome-panel p-6 space-y-5">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <label className="grid gap-1">
          ...
          <input
            ...
            className="px-4 py-3 rounded-xl bg-fc-input border border-white/[0.08] text-white placeholder:text-white/30"
          />
        </label>
        <div className="grid gap-1">
          ...
          <div className="grid grid-cols-2 gap-2">
            <select
              ...
              className="px-4 py-3 rounded-xl bg-fc-input border border-white/[0.08] text-white"
            >
            ...
            {draft.trigger.type === 'interval' ? (
              ...
              <div className="px-4 py-3 rounded-xl bg-white/[0.03] border border-white/[0.08] text-white/60 text-sm">
      ...
      <div className="grid lg:grid-cols-12 gap-6">
        <div className="lg:col-span-6 space-y-3">
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              <select
                ...
                className="px-3 py-2 rounded-xl bg-fc-input border border-white/[0.08] text-white text-[11px]"
                title="Add condition"
              >
          ...
          {draft.conditions.length === 0 ? (
            <div className="fc-light-glass-panel fc-light-chrome-panel p-4 text-white/60 text-sm">
              No conditions. Add one (or use “always”).
            </div>
          ) : (
            <div className="space-y-2">
              {draft.conditions.map((c, idx) => (
                <div key={idx} className="fc-light-glass-panel fc-light-chrome-panel p-4 space-y-3">
                  <div className="flex items-center justify-between gap-3">
                    <select
                      value={c.type}
                  ...
                  {c.type === 'partner_lane_in' && (
                    <div className="grid gap-1">
                      ...
                      <select
                        ...
                        className="px-3 py-2 rounded-xl bg-fc-input border border-white/[0.08] text-white text-[11px] min-h-[120px]"
                      >
                        {LANES.map((x) => (
                  ...
                  {c.type === 'partner_stage_in' && (
                    <div className="grid gap-1">
                      ...
                      <select
                        ...
                        className="px-3 py-2 rounded-xl bg-fc-input border border-white/[0.08] text-white text-[11px] min-h-[140px]"
                      >
                        {STAGES.map((x) => (
                          <option key={x} value={x}>
                            {x}
        ...
        <div className="lg:col-span-6 space-y-3">
          ...
          {draft.actions.length === 0 ? (
            <div className="fc-light-glass-panel fc-light-chrome-panel p-4 text-white/60 text-sm">No actions.</div>
          ) : (
            <div className="space-y-2">
                    ...
                    <div className="grid gap-3">
                      ...
                      <label className="grid gap-1">
                        ...
                        <textarea
                          ...
                          rows={3}
                          className="px-3 py-2 rounded-xl bg-fc-input border border-white/[0.08] text-white text-[11px] resize-y"
                        />
                      </label>
                    </div>
                  )}
                    ...
                    <div className="grid gap-3">
                      ...
                      <label className="grid gap-1">
                        ...
                        <select
                          ...
                          className="px-3 py-2 rounded-xl bg-fc-input border border-white/[0.08] text-white text-[11px] min-h-[90px]"
                        >
                          {TASK_KINDS.map((k) => (
                            <option key={k} value={k}>
                              {k}
                    ...
                    <div className="grid gap-3">
                      ...
                      <label className="grid gap-1">
                        ...
                        <textarea
                          ...
                          rows={6}
                          className="px-3 py-2 rounded-xl bg-fc-input border border-white/[0.08] text-white/80 text-xs font-mono resize-y"
                        />
                      </label>
                    </div>
                  )}
      ...
      <div className="rounded-2xl border border-white/[0.08] bg-fc-input p-4">
