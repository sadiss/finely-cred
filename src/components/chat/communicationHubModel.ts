...
export const AI_SUGGESTION_TREE: AiSuggestionNode[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 't-specialist', emoji: '🎓', label: 'Specialist partnership', prompt: 'I am a credit specialist — how should I use the partnership line vs partner threads?', navigate: '/portal/messages?hub=team&topic=credit_specialist_program' },
...
export const ROLE_CHANNELS: { role: string; label: string; emoji: string; path: string; desc: string }[] = [
  { role: 'client', label: 'Partner support threads', emoji: '👤', path: '/portal/messages', desc: 'You ↔ Finely operations and your specialist' },
