...
function avatarUrlFor(personaId: AgentPersonaId, staff: StaffMember | null): string {
  ...
  const roleFallbackStaff: Partial<Record<AgentPersonaId, string>> = {
    finely_advisor: 'staff-marcus-reed',
    dispute_coach: 'staff-dana-kim',
    funding_strategist: 'staff-leo-park',
    nurture_concierge: 'staff-ruby-santos',
    social_creator: 'staff-jamie-foster',
    support_specialist: 'staff-jordan-patel',
    appointment_setter: 'staff-brandon-kim',
    sales_closer: 'staff-riley-chen',
    lead_converter: 'staff-cameron-blake',
    debt_strategist: 'staff-tiffany-nguyen',
    ...
    evidence_specialist: 'staff-henry-ng',
...
const STAFF_ROSTER_FALLBACK = [
  ...
  { id: 'staff-henry-ng', firstName: 'Henry', lastName: 'Ng', portraitGender: 'masculine' as const, avatarPath: '' },
  { id: 'staff-tiffany-nguyen', firstName: 'Tiffany', lastName: 'Nguyen', portraitGender: 'feminine' as const, avatarPath: '' },
  { id: 'staff-brandon-kim', firstName: 'Brandon', lastName: 'Kim', portraitGender: 'masculine' as const, avatarPath: '' },
  { id: 'staff-dana-kim', firstName: 'Dana', lastName: 'Kim', portraitGender: 'feminine' as const, avatarPath: '' },
  { id: 'staff-leo-park', firstName: 'Leo', lastName: 'Park', portraitGender: 'masculine' as const, avatarPath: '' },
  { id: 'staff-ruby-santos', firstName: 'Ruby', lastName: 'Santos', portraitGender: 'feminine' as const, avatarPath: '' },
