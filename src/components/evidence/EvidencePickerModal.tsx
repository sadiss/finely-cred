...
export function EvidencePickerModal({
  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center p-4">
      ...
      <div
        className="relative w-full max-w-5xl rounded-3xl border border-white/10 bg-[#0a0f0d] shadow-2xl overflow-hidden"
        role="dialog"
        aria-modal="true"
          ...
          <div className="flex items-center gap-2">
            {onGoCapture ? (
              <button
                type="button"
                onClick={onGoCapture}
                className="hidden sm:inline-flex items-center gap-2 px-3 py-2 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 text-[10px] font-black uppercase tracking-widest text-white/70 transition-all"
                  ...
                  return (
                    <div
                      ...
                      className={`rounded-2xl border p-4 flex flex-wrap items-center justify-between gap-3 ${
                        selected ? 'border-amber-500/40 bg-amber-500/10' : 'border-white/10 bg-white/[0.02]'
                      }`}
                    >
                      <div className="min-w-0">
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-2 px-3 py-2 rounded-xl bg-white/5 border border-white/10 text-white/60 hover:text-white hover:bg-white/10 transition-all text-[10px] font-black uppercase tracking-widest"
                          title="Delete"
                        >
                          <Trash2 size={14} />
                          Delete
