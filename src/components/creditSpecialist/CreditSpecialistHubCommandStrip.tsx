...
export function CreditSpecialistHubCommandStrip({ clientCount = 0, openTasks = 0 }: Props) {
  ...
  return (
    <FinelyOsRoleCommandCenter
      ...
      subline="Customers · growth · training · partnership line — one strip for daily ops."
      tiles={[
        { id: 'clients', label: 'Customers', value: String(clientCount), accent: 'violet', onClick: () => navigate('/admin/partners') },
