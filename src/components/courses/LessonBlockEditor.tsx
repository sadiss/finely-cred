...
export function LessonBlockEditor({
  ...
  return (
    <div className="grid lg:grid-cols-12 gap-4">
      <div className="lg:col-span-5 rounded-2xl border border-white/10 bg-black/30 p-4 space-y-3">
              ...
              return (
                <button
                  ...
                  className={`w-full text-left rounded-2xl border p-3 transition-all ${
                    isActive ? 'border-amber-500/30 bg-amber-500/10' : 'border-white/10 bg-white/[0.02] hover:bg-white/[0.04]'
                  }`}
                >
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                      <button
                        ...
                        className="p-2 rounded-xl border border-white/10 bg-black/30 hover:bg-white/[0.03] text-white/70 disabled:opacity-40"
                        disabled={idx <= 0}
                        title="Move up"
                      >
                        <ArrowUp size={14} />
      ...
      <div className="lg:col-span-7 rounded-2xl border border-white/10 bg-white/[0.03] p-5 space-y-4">
        {!active ? (
            ...
            {active.type === 'markdown' || active.type === 'rich_text' || active.type === 'callout' || active.type === 'accordion' ? (
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  rows={10}
                  className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-white/85 text-sm placeholder:text-white/25 resize-y"
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  rows={12}
                  className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-white/80 text-xs font-mono resize-y"
                />
