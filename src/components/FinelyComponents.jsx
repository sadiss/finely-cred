    ...
    <div className="flex flex-col items-center group cursor-pointer text-white perspective-1000">
      <div className="relative w-40 h-60 md:w-44 md:h-64 mb-10 transition-transform duration-500 group-hover:scale-105 group-hover:-translate-y-4">
        <div className="relative w-full h-full transform-style-3d rotate-y-[-20deg] group-hover:rotate-y-[-5deg] transition-all duration-700 ease-out shadow-2xl">
          <div className="absolute inset-y-0 left-0 w-12 bg-[#0a0f0d] origin-right rotate-y-[-90deg] translate-x-[-12px] border-l border-white/[0.08] flex flex-col items-center py-6 gap-6 text-left shadow-[inset_10px_0_20px_rgba(0,0,0,0.8)] z-10">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-[#1a1a1a] to-[#050807] border-t border-r border-white/20 rounded-r-md shadow-[inset_0_0_30px_rgba(0,0,0,0.8),10px_10px_40px_rgba(0,0,0,0.6)] overflow-hidden flex flex-col justify-between p-6">
            ...
            <div className="relative z-10 text-left space-y-2">
              ...
              <p className="text-[8px] text-white/40 font-bold uppercase tracking-widest text-left border-l-2 border-white/[0.08] pl-2">{sub}</p>
            </div>
      ...
      <div className="text-center space-y-3 opacity-60 group-hover:opacity-100 transition-opacity duration-500 transform group-hover:translate-y-[-5px]">
        ...
        <div className="flex items-center justify-center gap-4 text-white">
          ...
          <div className="flex items-center gap-1.5 text-left bg-white/5 px-2 py-1 rounded-full border border-white/[0.08]">
...
export function MarketplaceCard({ bank, limit, age, price, date, theme, onSelect }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between pt-6 border-t border-white/[0.08] relative z-10 text-left">
      ...
      <button onClick={onSelect} className={`w-full mt-6 py-4 rounded-xl border border-white/[0.08] text-[10px] font-black uppercase tracking-[0.2em] transition-all hover:bg-white/10 hover:border-white/30 hover:scale-[1.02] active:scale-[0.98] ${config.accent} relative z-20`}>
        Secure AU Slot
      </button>
    </div>
  );
...
export function TradelineMarketplace({ onAddToCart, lines }) {
  ...
  return (
    <div className="w-full mt-20 md:mt-32 space-y-12">
      <div className="w-full bg-black/40 border-y border-white/[0.08] py-3 overflow-hidden">
...
export function ViolationLiveFeed() {
  ...
  return (
    <div className="w-full bg-black/40 border-y border-white/[0.08] py-6 md:py-8 overflow-hidden relative group">
