...
function btn(active: boolean, disabled: boolean) {
  return (
    ...
    (disabled
      ? 'opacity-60 cursor-not-allowed border-white/[0.08] bg-white/[0.02] text-white/40'
      : active
        ? 'border-amber-500/35 bg-amber-500/15 text-amber-100 hover:bg-amber-500/20'
        : 'border-white/[0.08] bg-white/5 hover:bg-white/10 text-white/70')
  );
}
    ...
    <div className={args.className || ''}>
      {showToolbar ? (
        <div className="sticky top-24 z-20">
          <div className="flex flex-wrap items-center gap-2 rounded-2xl border border-white/[0.08] bg-fc-chrome/95 backdrop-blur-xl p-2">
            {/* Style */}
            <div className="relative">
              ...
              {styleOpen ? (
                <div className="absolute z-20 mt-2 w-44 rounded-2xl border border-white/[0.08] bg-fc-shell shadow-2xl overflow-hidden">
                  {[
            ...
            <div className="relative">
              ...
              {colorOpen ? (
                <div className="absolute z-20 mt-2 w-56 rounded-2xl border border-white/[0.08] bg-fc-shell shadow-2xl overflow-hidden p-3">
                  ...
                  <div className="mt-2 grid grid-cols-6 gap-2">
                    {[
                      ...
                      <button
                        ...
                        className="h-7 rounded-lg border border-white/[0.08]"
                  ...
                  <button
                    ...
                    className="mt-3 w-full px-3 py-2 rounded-xl border border-white/[0.08] bg-white/5 hover:bg-white/10 text-[10px] font-black uppercase tracking-widest text-white/70 transition-all"
                  >
                    Reset color
                  </button>
                </div>
            ...
            <div className="relative">
              ...
              {insertOpen ? (
                <div className="absolute z-20 mt-2 w-64 rounded-2xl border border-white/[0.08] bg-fc-shell shadow-2xl overflow-hidden">
                  <div className="px-4 py-3 text-[10px] uppercase tracking-widest text-white/40 border-b border-white/[0.08]">Placeholders</div>
      ...
      {linkOpen ? (
        <div className="mt-3 rounded-2xl border border-white/[0.08] bg-fc-input p-4">
          ...
          <div className="mt-2 flex flex-wrap items-center gap-2">
            <input
              ...
              className="flex-1 min-w-[220px] bg-fc-input border border-white/[0.08] rounded-xl px-4 py-2 text-white/80 placeholder:text-white/30 focus:outline-none focus:border-amber-500 transition-colors text-sm"
            />
            <button
              type="button"
            ...
            <button
              type="button"
              className="px-4 py-2 rounded-xl border border-white/[0.08] bg-white/5 hover:bg-white/10 text-[10px] font-black uppercase tracking-widest text-white/70 transition-all"
      ...
      <div
        className={
          ...
          'mt-3 rounded-2xl border border-white/[0.08] bg-fc-input focus-within:border-amber-500 transition-colors'
        }
      >
        <div
