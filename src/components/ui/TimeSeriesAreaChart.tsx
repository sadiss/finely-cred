...
export function TimeSeriesAreaChart(args: {
  ...
  return (
    <div className="fc-light-glass-panel fc-light-chrome-panel p-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          {args.series.map((s) => (
            <span
              key={s.id}
              className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full fc-light-glass-panel fc-light-chrome-panel border text-[10px] font-black uppercase tracking-widest text-white/70"
              title={s.label}
            >
