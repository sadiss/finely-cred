    ...
    return (
      <div className="min-h-[70vh] w-full flex items-center justify-center px-6 py-16">
        <div className="max-w-lg w-full rounded-3xl border border-rose-500/25 bg-rose-500/10 backdrop-blur-xl p-8 space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-rose-500/25 bg-white/[0.07] text-rose-100 text-[10px] font-black uppercase tracking-widest">
          ...
          <div className="pt-2 flex flex-wrap gap-3">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-5 py-2.5 fc-light-glass-panel fc-light-chrome-panel rounded-xl hover:bg-white/[0.03] text-[10px] font-black uppercase tracking-widest text-white/80 transition-all"
            >
              Home <Home size={14} />
            </button>
          </div>
