...
function commonInputClass() {
  return 'mt-2 w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-white/80 placeholder:text-white/20 focus:outline-none focus:border-amber-500 transition-colors';
}
          ...
          <div key={s.id} className="rounded-2xl border border-white/10 bg-black/30 p-5">
            ...
            <div className="mt-4 grid md:grid-cols-2 gap-4">
              {visible.map((def) => {
                ...
                return (
                  <div key={def.id} className="rounded-2xl border border-white/10 bg-black/40 p-4">
