...
export function MarketingConsentBlock({
  ...
  return (
    <div className={`rounded-2xl border border-white/10 bg-white/[0.03] p-4 space-y-3 ${className}`}>
      ...
      <label className="flex items-start gap-3 text-white/70 text-sm cursor-pointer">
        ...
        />
        <span>
          Yes — you may email me updates, offers, and educational content. <span className="text-white/50">Unsubscribe anytime.</span>
        </span>
      </label>
