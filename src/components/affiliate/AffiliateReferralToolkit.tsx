  ...
  return (
    <div className="fc-spotlight-panel p-6 space-y-5">
      ...
      <div className="fc-light-glass-panel fc-light-chrome-panel rounded-xl p-4 flex items-start gap-3 text-sm text-white/55">
        ...
        <p>
          Tip: pair these links with your payout calculator numbers when pitching — upfront package payout plus recurring membership share, and Denefit contract streams when customers finance in-house.
        </p>
      </div>
    </div>
  );
