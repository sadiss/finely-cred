      ...
      <div className="rounded-2xl border border-white/10 bg-black/30 backdrop-blur-xl overflow-hidden">
        ...
        <div className="grid grid-cols-7 gap-0">
          {weeks.map(({ day, inMonth }) => {
            ...
            return (
              <div key={k} className="min-h-[120px] border-t border-white/10 border-r border-white/10 p-3">
                ...
                <div className="mt-2 space-y-1">
                  {dayItems.slice(0, 4).map((it) => (
                    <div
                      key={it.id}
                      className="rounded-lg border border-white/10 bg-white/[0.02] px-2 py-1 text-[11px] text-white/75 truncate"
                      style={{
                        borderLeftWidth: 3,
