...
const FLYER: Record<string, LeadMagnetFlyerContent> = {
  ...
  restore_wealth: {
    powerLine: 'RESTORE FOR WEALTH.',
    categoryLabel: 'CREDIT RESTORE · FUNDING',
    taglineBar: 'RESTORE THE FILE. THEN FUND THE NEXT CHAPTER. DEBT IS NOT ERASED.',
    benefitsTitle: 'With this guide you can:',
    processTitle: 'The restore-for-wealth sequence',
    resultsTitle: 'What you get',
    accessTitle: 'Inside the download',
    foundationTitle: 'What stays true',
    ctaBannerLine: 'LEAVE A NUMBER. WE CALL YOU.',
    ctaBannerSub: 'Phone required. We’ll call within 1 business day.',
    process: [
      { label: '01', title: 'Download the guide' },
      { label: '02', title: 'Read the honesty brief' },
      { label: '03', title: 'Sequence the file' },
      { label: '04', title: 'Take the specialist call' },
      { label: '05', title: 'Prepare the funding ask' },
    ],
    metrics: [
      { value: '1 day', label: 'Call SLA' },
      { value: '$0', label: 'No card' },
      { value: 'No hype', label: 'No score promises' },
    ],
    access: [
      { title: 'Funding purpose', desc: 'Why restore exists — capital, housing, opportunity.' },
      { title: 'Honesty brief', desc: 'Debt is not erased. Results vary.' },
      { title: 'File sequence', desc: 'High-impact items, utilization, inquiry discipline.' },
      { title: 'Call follow-up', desc: 'A specialist on the number you leave.' },
    ],
    foundation: [
      { title: 'Not the dispute DIY door', desc: 'Letter-writing learners belong on /free-guide.' },
      { title: 'Educational only', desc: 'Not legal advice. Funding subject to underwriting.' },
      { title: 'One primary action', desc: 'Leave name, email, and phone.' },
    ],
  },
  kreyol: {
    powerLine: 'RESTORE KREDI. BATI RICHÈS.',
    categoryLabel: 'BIWO AYISYEN',
    taglineBar: 'GID KREYÒL POU FANMI AK ESPESYALIS — NOU PRAL RELE W.',
