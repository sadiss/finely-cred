...
export const LEAD_MAGNET_PREMIUM_PROFILES: Record<string, LeadMagnetPremiumProfile> = {
  ...
  restore_wealth: profile({
    accent: 'amber',
    heroProof: [
      'Credit restore for funding and opportunity — not a vanity score',
      'Debt is not erased. Results vary. No score promises.',
      'We’ll call within 1 business day',
    ],
    problemTitle: 'Restore so the next chapter can be funded.',
    problemBody:
      'A score screenshot is not a plan. This guide treats credit restore as a tool for housing, capital, and cheaper money — with honesty about debt and underwriting.',
    painPoints: [
      'You want funding or a next asset, but the file still tells the wrong story.',
      'Generic “credit repair” copy promised jumps no honest operator would quote.',
      'Debt is still sitting there and nobody said that out loud.',
      'No one mapped restore work to a funding conversation.',
    ],
    chapters: [
      { title: 'Funding is the point', bullets: ['What underwriters read', 'Why vanity scores stall', 'A restore-to-capital sequence'] },
      { title: 'Honesty brief', bullets: ['Debt is not erased', 'Results vary', 'No score guarantees'] },
      { title: 'The sequence', bullets: ['High-impact items first', 'Utilization while disputes run', 'Inquiry discipline'] },
      { title: 'The funding conversation', bullets: ['Purpose and amount', 'Document pack', 'When to book a specialist'] },
    ],
    tracks: [
      {
        id: 'funding',
        label: 'Funding path',
        promise: 'Treat restore as a capital tool.',
        bestFor: 'Partners who want a house, a line, or a business ask.',
        plan: ['Read the sequence', 'Upload the file', 'Take the call'],
      },
      {
        id: 'honesty',
        label: 'Honesty first',
        promise: 'Know what restore cannot do.',
        bestFor: 'Anyone tired of repair-shop hype.',
        plan: ['Read the brief', 'Keep valid debt in view', 'Skip score promises'],
      },
      {
        id: 'file',
        label: 'File work',
        promise: 'Sequence the report before you apply.',
        bestFor: 'Pre-funding restorers.',
        plan: ['Mark high-impact items', 'Hold inquiry budget', 'Stabilize utilization'],
      },
      {
        id: 'session',
        label: 'Human map',
        promise: 'A specialist call within one business day.',
        bestFor: 'Partners who want a walkthrough.',
        plan: ['Leave a phone number', 'Take the call', 'Book a session if you want a set time'],
      },
    ],
    timeline: [
      { step: 'Today', detail: 'Download the guide and leave a reachable number.' },
      { step: '1 business day', detail: 'A specialist calls to map restore toward funding readiness.' },
      { step: 'This week', detail: 'Mark high-impact items and upload a report if you want the portal preview.' },
      { step: 'When ready', detail: 'Start the funding conversation from a file an underwriter can read.' },
    ],
    bonusTools: [
      { title: 'Honesty brief', desc: 'Debt is not erased. Results vary. Funding is underwritten.' },
      { title: 'Funding-readiness checklist', desc: 'Purpose, amount, and documents before you apply.' },
      { title: 'Call SLA', desc: 'We call the number you leave within one business day.' },
    ],
    portalHighlights: SHARED_PORTAL,
    captureHeadline: 'Get the Restore for Wealth guide',
    captureSub: `Phone required. We’ll call within 1 business day. ${ONE_COMPLIANCE}`,
    successHeadline: 'Your Restore for Wealth guide is ready',
    formStepTitle: 'Unlock the wealth path',
    formStepSub: 'Leave a reachable number. Alex will follow up. Debt is not erased. Results vary.',
    faqs: [
      { q: 'Will this raise my score?', a: 'No one can promise a jump. Results vary by the facts on your file.' },
      { q: 'Does restore erase debt?', a: 'No. Valid obligations still exist. This guide is honest about that.' },
      { q: 'Is this the dispute letter guide?', a: 'No. If you want to learn to write letters yourself, use /free-guide. This door is restore for funding and opportunity.' },
    ],
  }),

  kreyol: profile({
    accent: 'emerald',
    heroProof: ['Biwo Ayisyen', 'Pale Kreyòl', 'Nou pral rele w nan 1 jou ouvrab'],
    ...
    captureHeadline: 'Pran gid Kreyòl la',
    captureSub: `Kat feyè + Biwo Ayisyen. Telefòn obligatwa. ${ONE_COMPLIANCE}`,
