...
const THEMES: Record<string, LeadMagnetVisualTheme> = {
  ...
  agency: {
    ...
    heroImage: '/images/lead-magnets/agency-guide-book.png',
    heroImageAlt: 'The Agency Guide — e-guide cover',
    videoPosterImage: 'https://images.unsplash.com/photo-1497366754035-f200968a6e72?auto=format&fit=crop&w=1400&q=90',
    badge: 'Agency wealth',
    tagline: 'Scale on systems — ink, gold, and freedom.',
    colors: {
      bgFrom: '#050a14',
      bgTo: '#06101f',
      meshA: '212,164,71',
      meshB: '240,204,117',
      accent: '#d4a447',
      accentRgb: '212,164,71',
      accent2: '#f0cc75',
      accent2Rgb: '240,204,117',
      overlayFrom: 'rgba(6,16,31,0.78)',
      overlayTo: 'rgba(212,164,71,0.22)',
      gradFrom: '#f5e6c0',
      gradMid: '#f0cc75',
      gradTo: '#d4a447',
    },
  ...
  partner_refer: {
    id: 'partner_refer',
    meshClass: 'lm-theme-score',
    heroImage: '/free-guide-cover.png',
    heroImageAlt: 'Finely Cred credit restore — partner referral',
    videoPosterImage: '/images/product-shots/free-guide-desktop.png',
    badge: 'Partner referral',
    tagline: 'A partner sent you. We call you.',
    colors: {
      bgFrom: '#1a1408',
      bgTo: '#0c0904',
      meshA: '245,158,11',
      ...
      overlayFrom: 'rgba(69,26,3,0.72)',
      overlayTo: 'rgba(245,158,11,0.28)',
      gradFrom: '#fde68a',
      gradMid: '#fbbf24',
      gradTo: '#d97706',
    },
  ...
  affiliate: {
    ...
    // Branded cover (SVG) — replace with photographed book mockup when available.
    heroImage: '/images/lead-magnets/affiliate-toolkit-book.svg',
    heroImageAlt: 'Affiliate Referral Toolkit — e-guide cover',
    videoPosterImage: '/images/lead-magnets/affiliate-toolkit-book.svg',
