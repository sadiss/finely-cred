      ...
      >
        <div className="p-6 border-b border-white/10 flex items-start justify-between gap-4">
          ...
          <button
            ...
            onClick={onClose}
            disabled={busy}
            className="p-2 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 text-white/70 disabled:opacity-60"
            title="Close"
          >
            <X size={16} />
          </button>
        ...
        <div className="p-6 space-y-6 max-h-[78vh] overflow-y-auto">
            ...
            <div className="flex flex-wrap items-start justify-between gap-3">
              ...
              <div className="flex flex-wrap items-center gap-2">
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-xl border border-white/10 bg-black/30 hover:bg-white/[0.03] text-[10px] font-black uppercase tracking-widest text-white/80 disabled:opacity-60"
                >
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-5 space-y-4">
            ...
            {verifyRes ? (
              ...
              <div className="flex items-start gap-3 rounded-xl border border-white/10 bg-black/30 p-4 text-white/70 text-sm">
          ...
          <div className="flex items-center justify-end gap-3">
            <button
              ...
              onClick={onClose}
              disabled={busy}
              className="px-4 py-2 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 text-[10px] font-black uppercase tracking-widest text-white/70 disabled:opacity-60"
            >
              Cancel
            </button>
            <button
