/** Homepage — cinematic debt eradication highlight band. */
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-5xl relative z-10">
        <Reveal>
          <div className="relative overflow-hidden rounded-[1.75rem] border border-[#e0b24a]/30 bg-gradient-to-br from-[#060c2f]/90 via-[#0a1628]/85 to-[#020618]/95 px-6 py-10 sm:px-12 sm:py-14 shadow-[0_40px_100px_-40px_rgba(0,0,0,0.75)]">
            ...
            <div className="relative text-center max-w-2xl mx-auto">
              <p className="fc-sell-kicker mb-5">Debt eradication</p>
              <LandingTypewriterTitle
                text="Collections stacking? "
                accentText="Take the playbook."
                className="fc-sell-serif text-4xl sm:text-5xl lg:text-[3.4rem] font-semibold leading-[1.08] text-white"
                accentClassName="text-[#ffd993] italic"
              />
              <Reveal delay={220}>
                <p className="mt-5 text-base sm:text-lg text-white/58 leading-relaxed">
                  When collectors call, summons arrive, or foreclosure pressure builds — you need a clear sequence, not
                  guesswork. The free debt eradication guide maps validation, defense posture, and rebuild steps for
