...
export const BUNDLES: BundleTemplate[] = [
  {
    ...
    title: 'Triple Tradeline Timed Bundle (Denefits + Primary + 2 AU)',
    priceHint: '$1,000 (example)',
    description:
      'A time-sensitive build sequence: Denefits installment plan (reports to Equifax) + a primary tradeline + 2 authorized user lines. The goal is to time AUs for the application window, not too early.',
    timeline: [
      {
      ...
      {
        title: 'Enroll in Denefits plan (3-pay)',
        kind: 'general',
        stage: 'funding',
        priority: 'high',
        dueInDays: 2,
        notes: 'Start the Denefits installment plan so it can begin reporting (Equifax).',
