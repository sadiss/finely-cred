...
const SHEETS: BusinessCreditOneSheetSpec[] = [
  {
    ...
    includes: [
      ...
      'CTA path: Process Brief → tier sheets → work-calibrated quote',
    ...
    proofPoints: [
      ...
      'Pairs with Process Brief (how) and Tier Ladder (pricing outlook)',
    ],
    cta: 'Next: download the Process Brief, then Tier Ladder & Capital Outlook + your tier sheet — quote at /pricing/business-credit. Book a session with this roadmap in hand.',
