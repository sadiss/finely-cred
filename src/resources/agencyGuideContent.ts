 ...
 * Matches the landing page promise: offer clarity, client attraction, smart
...
export const AGENCY_GUIDE: FreeGuide = {
  ...
  desc: 'Build a profitable agency, attract better clients, and create more time, income, and freedom — offer clarity, client attraction, smart systems, and scalable structure for credit-services agencies.',
  sections: [
    {
      ...
      bullets: [
        ...
        'Give you a repeatable framework to define your offer, attract better-fit clients, and deliver consistently without your calendar owning you.',
        ...
        'This is education, not a guarantee of revenue, client count, or timeline — results vary by market, effort, and execution.',
    ...
    {
      heading: '3. Client attraction — position for the right clients',
      bullets: [
        'Ideal clients are not "anyone with a pulse and a credit problem" — define who you serve best and say no to the rest.',
        ...
        'WARNING: Never promise specific score increases, guaranteed deletions, or funding amounts in marketing copy — compliance-safe language protects the agency and the client.',
    ...
    },
    {
      ...
      bullets: [
        ...
        'Use a shared operating system (like the Finely Cred partner OS) so client files, evidence, and letters live in one place instead of scattered folders and inboxes.',
        'Build a "day 1 to day 30" client journey map so every new client gets the same quality experience regardless of who on your team handles it.',
        'KEY: Systems are what let you serve client 50 the same way you served client 1 — without you personally touching every file.',
    ...
    },
    {
      ...
      bullets: [
        ...
        'Track a simple weekly scoreboard: new clients, active files, completed milestones, and referrals generated — revenue lags these leading indicators.',
    ...
    },
    {
      ...
      bullets: [
        ...
        'TIP: Ask three current clients why they chose you over a competitor — their exact words are your best positioning copy.',
      ],
    },
    {
    ...
    },
    {
      ...
      bullets: [
        'Week 1 — Write your one-sentence offer; define your ideal client; set up intake form and document checklist.',
        'Week 2 — Build your onboarding sequence and evidence vault structure; draft compliance-safe marketing copy.',
        'Week 3 — Publish one teaching piece of content; ask two past clients for referrals or testimonials with permission.',
    ...
    },
    {
      ...
      bullets: [
        ...
        'Ideal-client positioning checklist — who you serve, who you refer out.',
