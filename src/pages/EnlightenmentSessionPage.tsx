    ...
    >
      <div className="space-y-8">
        ...
        <div className="fc-panel border-emerald-500/25 bg-emerald-500/10 p-5 text-sm text-emerald-100 flex items-start gap-3">
          ...
          <div>
            <div className="font-semibold text-white">This session is designed to clarify your next steps</div>
            <p className="mt-1 text-white/70">
              Share your goal and availability. We’ll confirm the best lane (Primary vs AU vs Debt Kill, etc.) and schedule your session.
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          <div className="lg:col-span-7 fc-card p-6 space-y-4">
            ...
            <form onSubmit={onSubmit} className="space-y-4">
              <div>
                <label className="block text-[10px] uppercase tracking-widest text-white/50 mb-1">Session focus</label>
                <select
                  value={focus}
                  onChange={(e) => setFocus(e.target.value as FocusLane)}
