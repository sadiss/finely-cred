...
export const DEBT_GUIDE_META: GuideMeta = {
  title: 'The Debt Validation Field Manual',
  shortTitle: 'Debt Field Manual',
  tagline: 'Collections, validation, summons response, and the rebuild after',
  description:
    'A free in-app field manual for partners under debt pressure: the first seventy-two hours, who actually owns the debt, validation leverage, evidence discipline, summons education, settlement math, and the rebuild after resolution.',
...
export const DEBT_GUIDE_CHAPTERS: GuideChapter[] = [
  {
    ...
    kicker: 'Open here',
    teaser: 'Stabilize, inventory, and calendar. A rushed yes costs more than any single debt.',
    readMinutes: 7,
    promise: 'Leave this page with a written inventory, a deadline calendar, and zero decisions made under pressure.',
    takeaway: 'Nothing gets paid, promised, or admitted until the debt is inventoried and the deadlines are on paper.',
    sections: [
      {
        heading: 'Stabilize the file before you choose a tactic',
        kicker: 'Triage',
        blocks: [
          {
            kind: 'paragraphs',
      ...
      },
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            rows: [
              ['Summons / complaint (court caption, case number)', 'Highest — a hard deadline is running', 'Confirm the answer deadline for your court, then read Pages V–VI'],
              ...
              ['First contact letter from a collector', 'High — validation window is open', 'Send a written validation request (Page III)'],
          ...
          },
          {
            ...
            body: 'Read straight through once so you know what exists. Then return to the page that matches the envelope in your hand. Educational only · not legal advice · results vary.',
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    subtitle: 'The written request that turns a phone call into a paper case',
  ...
  },
  {
    ...
    subtitle: 'Reading a summons and complaint with a deadline plan',
    ...
    sections: [
      ...
      {
        heading: 'What the papers look like',
        kicker: 'The packet',
        blocks: [
          {
            kind: 'paragraphs',
            items: [
              'The summons names the court, the parties, and the days you have to answer. The complaint is the claim that arrives with it.',
            ],
          },
          {
            kind: 'sampleDocument',
            ...
            lines: [
              ...
              '    Miami, Florida 33125',
              '',
              'Each defendant is required to serve written defenses to the complaint',
              'on Plaintiff\'s attorney, whose name and address appear below, within',
              '20 days after service of this summons, exclusive of the day of service,',
              'and to file the original of the defenses with the Clerk of this Court',
              'either before service on Plaintiff\'s attorney or immediately thereafter.',
              'If a defendant fails to do so, a default will be entered against that',
              'defendant for the relief demanded in the complaint.',
              '',
              'IMPORTANT. A lawsuit has been filed against you. You have 20 calendar',
              'days after this summons is served on you to file a written response to',
              'the attached complaint with this court and to serve a copy on Plaintiff\'s',
              'attorney. A phone call does not protect you. You may want to call an',
              'attorney right away. If you do not file your response on time, you may',
              'lose the case, and your wages, money, and property may later be taken',
              ...
              'By: ___________________________  Deputy Clerk',
              '',
              'Rivas & Hale, P.A.',
          ...
          },
          {
            ...
            lines: [
              ...
              'COMPLAINT',
              '',
              'Plaintiff Midland Credit Management, Inc. sues Defendant Elena R.',
              'Baptiste and alleges:',
              '',
              '1. This is an action for damages that exceed $8,000.00, exclusive of',
              '   interest, costs, and attorney\'s fees, and that do not exceed $50,000.00.',
              '',
              '2. Plaintiff is a Delaware corporation. Defendant is an individual',
              '   residing in Miami-Dade County, Florida. Venue is proper in this Court.',
              '',
              '3. On or about June 11, 2019, Defendant opened a credit-card account',
              '   with Capital One, N.A., account ending 4418.',
              '',
              '4. Defendant defaulted on the account. The last payment posted on',
              '   January 7, 2023.',
              '',
              '5. Plaintiff purchased the account from Capital One, N.A. and is the',
              '   current owner entitled to collect the balance.',
              '',
              '6. The principal balance due is $4,817.36, plus interest as allowed by',
              '   the agreement and by law. Despite demand, Defendant has failed to pay.',
              '',
              'WHEREFORE, Plaintiff demands judgment against Defendant for $4,817.36,',
              'plus interest, court costs, and such other relief as this Court deems proper.',
              '',
          ...
          },
          {
            ...
            lines: [
              ...
              '',
              'I certify that on March 18, 2024, I served a true and correct copy of',
              'the Summons and Complaint in the above-entitled matter upon:',
              '',
              '    Elena R. Baptiste',
              '    1842 NW 17th Avenue',
              '    Miami, Florida 33125',
          ...
          },
          {
            kind: 'callout',
            tone: 'note',
            title: 'Compare to your packet',
            body: 'Highlight the response deadline on the summons, each numbered paragraph in the complaint, and whether exhibits are actually attached. Bring those three observations to your first consultation. These are fictional, redacted teaching copies — not a partner’s court papers. Results vary · not legal advice.',
          },
        ],
      },
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            items: [
              ...
              { label: 'Assemble the file', body: 'Bring the four-drawer file from Page IV. Preparation converts an expensive consultation into a productive one.' },
            ],
          },
          {
            kind: 'callout',
            tone: 'law',
            title: 'Scope note',
            body: 'This page is education about how debt litigation works, not legal advice about your case. Court rules, deadlines, and defenses are state-specific. A licensed attorney in your jurisdiction is the right person to advise you.',
          },
        ],
      },
    ],
  ...
  },
  {
    id: 'settlement',
    number: 'VIII',
    title: 'Settlement From Information',
    subtitle: 'Negotiating from a verified file instead of a threat',
    kicker: 'Resolution',
  ...
  },
  {
    ...
    subtitle: 'Turning resolution into a stronger file',
    kicker: 'Forward',
