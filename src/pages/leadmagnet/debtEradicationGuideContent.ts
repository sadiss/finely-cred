...
export const DEBT_GUIDE_CHAPTERS: GuideChapter[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: 'What the papers look like (redacted teaching copies)',
        kicker: 'Samples',
        blocks: [
          {
            kind: 'paragraphs',
            items: [
              'Real court papers use your name, your county, and a case number assigned by the clerk. The blocks below are fictional layouts with every identifying field scrubbed so you can practice reading structure — not copy language into a filing.',
            ],
          },
          {
            kind: 'sampleDocument',
            title: 'Sample summons — face (redacted)',
            lines: [
              '══════════════════════════════════════════════════════',
              '              [GENERIC COUNTY] COURT OF [STATE]',
              '           CIVIL DIVISION — CONSUMER DEBT MATTER',
              '══════════════════════════════════════════════════════',
              '',
              'Case No. CV-20XX-00000        (fictional · not a real docket)',
              '',
              'PLAINTIFF:   [DEBT BUYER LLC]',
              'DEFENDANT:  [PARTNER NAME — REDACTED]',
              '',
              'SUMMONS',
              '',
              'TO THE ABOVE-NAMED DEFENDANT:',
              '',
              'You are being sued. A complaint has been filed against you.',
              'You must file a written response with this court and serve a copy',
              'on the plaintiff\'s attorney within ___ days after you were served.',
              '(Your court\'s rule controls — confirm with the clerk.)',
              '',
              'If you do not respond, the court may enter judgment against you',
              'for the amount claimed in the complaint without further notice.',
              '',
              'Clerk of Court: [ADDRESS REDACTED]',
              '══════════════════════════════════════════════════════',
            ],
          },
          {
            kind: 'sampleDocument',
            title: 'Sample complaint — opening allegations (excerpt)',
            lines: [
              'COMPLAINT FOR MONEY DAMAGES',
              '',
              'Plaintiff [DEBT BUYER LLC] alleges:',
              '',
              '1. Plaintiff is a [entity type] organized under the laws of [STATE].',
              '',
              '2. Defendant is an individual residing in [COUNTY REDACTED], [STATE].',
              '',
              '3. Defendant entered into a credit agreement with [ORIGINAL CREDITOR',
              '   REDACTED] for account ending in ••••1234.',
              '',
              '4. Defendant defaulted. Plaintiff purchased the account and is',
              '   entitled to collect the balance of $[AMOUNT REDACTED].',
              '',
              '5. Despite demand, Defendant has failed to pay.',
              '',
              'WHEREFORE, Plaintiff requests judgment for $[AMOUNT REDACTED],',
              'plus costs, interest as allowed by law, and other relief.',
              '',
              'Exhibits attached: [ ] account summary  [ ] bill of sale  [ ] none',
              '',
              'Respectfully submitted,',
              '[COLLECTION LAW FIRM — REDACTED]',
            ],
          },
          {
            kind: 'sampleDocument',
            title: 'Sample certificate of service (redacted layout)',
            lines: [
              'CERTIFICATE OF SERVICE',
              '',
              'I certify that on [DATE REDACTED], I served a true and correct copy of',
              'the Summons and Complaint in the above-entitled matter upon:',
              '',
              '    [PARTNER NAME — REDACTED]',
              '    [SERVICE ADDRESS — REDACTED]',
              '',
              'By:  [ ] personal delivery   [ ] certified mail   [ ] other: _______',
              '',
              '_______________________________',
              '[PROCESS SERVER / ATTORNEY NAME — REDACTED]',
              '',
              '(Layout varies by state and court — use this only to recognize the',
              ' section when it appears in your packet, not as a template to file.)',
            ],
          },
          {
            kind: 'callout',
            ...
            body: 'Highlight the response deadline on the summons, each numbered paragraph in the complaint, and whether exhibits are actually attached. Bring those three observations to your first consultation — outcomes are never guaranteed.',
          },
        ],
      },
      {
