...
function StatusBadge({ status }: { status: 'not_configured' | 'test_mode' | 'live' }) {
  const colors = {
    ...
    test_mode: 'bg-amber-500/20 text-amber-400',
  ...
  return (
    <span className={`px-2 py-0.5 rounded-full text-[10px] font-semibold uppercase ${colors[status]}`}>
      {labels[status]}
    </span>
  );
}
    ...
    <div className="space-y-1">
      ...
      <div className="relative">
        <input
          ...
          className="w-full px-4 py-2.5 pr-10 rounded-xl border border-white/10 bg-black/30 text-white placeholder-white/30 text-sm font-mono focus:outline-none focus:border-amber-500/50"
        />
        <button
          type="button"
      ...
      {helperText && <p className="text-white/40 text-xs">{helperText}</p>}
    </div>
  );
}
  ...
  return (
    <div className="space-y-1">
      ...
      <input
        ...
        onChange={(e) => onChange(e.target.value)}
        placeholder={placeholder}
        className="w-full px-4 py-2.5 rounded-xl border border-white/10 bg-black/30 text-white placeholder-white/30 text-sm focus:outline-none focus:border-amber-500/50"
      />
      {helperText && <p className="text-white/40 text-xs">{helperText}</p>}
    </div>
  );
        ...
        <div className="space-y-6">
          {activeTab === 'home' && (
            <div className="space-y-6">
              <div className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-6">
                <div className="text-[10px] uppercase tracking-widest text-white/40">Settings overview</div>
                <div className="mt-2 text-white/70 text-sm">
                  Pick a category below. Everything deep-links via <span className="font-mono">?tab=…</span> so you can share direct URLs with your team.
                </div>
              </div>

              <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-4">
                {TABS.filter((t) => t.key !== 'home').map((t) => (
                  <ClickableCard key={t.key} onClick={() => goTab(t.key)} className="p-6">
                    <div className="flex items-start justify-between gap-4">
                      <div className="min-w-0">
                        ...
                        <div className="mt-3 text-white text-lg font-semibold">{t.label}</div>
                      ...
                      <div className="shrink-0 px-3 py-2 rounded-xl border border-white/10 bg-black/30 text-[10px] font-black uppercase tracking-widest text-white/70">
                        Open
                      </div>
                    </div>
                  </ClickableCard>
              ...
              <div className="rounded-2xl border border-white/10 bg-black/30 p-6 space-y-3">
                ...
                <div className="text-white/60 text-sm">
                  Shortcuts to the other admin areas that affect permissions and visibility. (These are the usual “where do I change this?” pages.)
                </div>
                <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-4 pt-2">
                  <ClickableCard onClick={() => navigate('/admin/access')} className="p-5">
                    <div className="inline-flex items-center gap-2 text-amber-300">
                      <Shield size={16} />
                      <span className="text-[10px] uppercase tracking-widest text-white/40">Control Center</span>
                    </div>
                    <div className="mt-2 text-white font-semibold">Access & Permissions</div>
                    <div className="mt-1 text-white/55 text-sm">Admin emails, tenant scope, effective capabilities.</div>
                  </ClickableCard>
                  <ClickableCard onClick={() => navigate('/admin/team')} className="p-5">
                    <div className="inline-flex items-center gap-2 text-amber-300">
                      <Users size={16} />
                      <span className="text-[10px] uppercase tracking-widest text-white/40">Team</span>
                    </div>
                    <div className="mt-2 text-white font-semibold">Team & Roles</div>
                    <div className="mt-1 text-white/55 text-sm">Membership, roles, assignments.</div>
                  </ClickableCard>
                  <ClickableCard onClick={() => navigate('/admin/billing')} className="p-5">
                    <div className="inline-flex items-center gap-2 text-amber-300">
                      <CreditCard size={16} />
                      <span className="text-[10px] uppercase tracking-widest text-white/40">Billing</span>
                    </div>
                    <div className="mt-2 text-white font-semibold">Billing & Entitlements</div>
                    <div className="mt-1 text-white/55 text-sm">Access grants and plan state.</div>
                  </ClickableCard>
                  <ClickableCard onClick={() => navigate('/admin/templates')} className="p-5">
                    <div className="inline-flex items-center gap-2 text-amber-300">
                      <FileText size={16} />
                      <span className="text-[10px] uppercase tracking-widest text-white/40">Templates</span>
                    </div>
                    <div className="mt-2 text-white font-semibold">Template Library</div>
                    <div className="mt-1 text-white/55 text-sm">Saved templates and generator outputs.</div>
                  </ClickableCard>
                </div>
              </div>
            </div>
          ...
          {activeTab === 'site' && (
            <div className="grid lg:grid-cols-2 gap-6">
              ...
              <div className="lg:col-span-2 rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-6 space-y-4">
                <div className="flex items-center gap-2 text-amber-400">
                  <Link size={18} />
                ...
                <div className="flex flex-wrap gap-3">
                  {[
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-2 px-4 py-2 rounded-xl border border-white/10 bg-black/30 hover:bg-white/[0.05] text-white/80 text-sm"
                    >
          ...
          {activeTab === 'chat' && (
            <div className="grid lg:grid-cols-2 gap-6">
              ...
              <div className="rounded-2xl border border-white/10 bg-black/30 backdrop-blur-xl p-6 space-y-4">
                <div className="text-[10px] uppercase tracking-widest text-white/40">Recommendation</div>
              ...
              <div className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-6 space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="rounded-2xl border border-white/10 bg-black/30 p-4 space-y-2">
                    <div className="text-[10px] uppercase tracking-widest text-white/40">Secret Key</div>
                    <div className="text-white/70 text-sm">
                      Stored server-side. Configure <span className="font-mono text-white/85">STRIPE_SECRET_KEY</span> in Supabase secrets.
                    </div>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="rounded-2xl border border-white/10 bg-black/30 p-4 space-y-2">
                    <div className="text-[10px] uppercase tracking-widest text-white/40">Webhook Signing Secret</div>
                    <div className="text-white/70 text-sm">
                      Stored server-side. Configure <span className="font-mono text-white/85">STRIPE_WEBHOOK_SECRET</span> in Supabase secrets.
                    </div>
                  </div>
                  <TextInput
            ...
            <div className="space-y-6">
              <div className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-6 space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-[10px] uppercase tracking-widest text-white/40 font-mono">global</div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <label className="text-white/60 text-xs uppercase tracking-wider">Markup %</label>
                    <input
                      type="number"
                      min={-50}
                      max={300}
                      ...
                      className="w-full px-4 py-2.5 rounded-xl border border-white/10 bg-black/30 text-white placeholder-white/30 text-sm focus:outline-none focus:border-amber-500/50"
                    />
                    <p className="text-white/40 text-xs">Example: 15 means +15%.</p>
                  </div>
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 rounded-xl border border-white/10 bg-black/30 text-white placeholder-white/30 text-sm focus:outline-none focus:border-amber-500/50"
                    />
                    <p className="text-white/40 text-xs">Example: 10 means −10% after markup.</p>
                  </div>
                </div>
              ...
              <div className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-6 space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-[10px] uppercase tracking-widest text-white/40 font-mono">JSON</div>
                </div>
                ...
                <textarea
                  ...
                  className="w-full min-h-[260px] bg-black/40 border border-white/10 rounded-2xl px-4 py-3 text-white/80 font-mono text-[12px] focus:outline-none focus:border-amber-500 transition-colors"
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-6 space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  />
                  <div className="rounded-2xl border border-white/10 bg-black/30 p-4 space-y-2">
                    <div className="text-[10px] uppercase tracking-widest text-white/40">API Key</div>
                    <div className="text-white/70 text-sm">
                      Stored server-side. Configure <span className="font-mono text-white/85">DENEFITS_API_KEY</span> in Supabase secrets.
                    </div>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  />
                  <div className="rounded-2xl border border-white/10 bg-black/30 p-4 space-y-2">
                    <div className="text-[10px] uppercase tracking-widest text-white/40">Webhook Secret</div>
                    <div className="text-white/70 text-sm">
                      Stored server-side. Configure <span className="font-mono text-white/85">DENEFITS_WEBHOOK_SECRET</span> in Supabase secrets.
                    </div>
                  </div>
                </div>
              ...
              <div className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-6 space-y-6">
                ...
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div className="text-white/60 text-sm">
                    Showing <span className="text-white/80 font-semibold">{filteredFinancingPackages.length}</span> of{' '}
                    <span className="text-white/80 font-semibold">{financingPackages.length}</span>
                  </div>
                  <div className="flex items-center gap-2 px-4 py-2 rounded-xl border border-white/10 bg-black/30">
                    <Search size={16} className="text-white/40" />
                    <input
                      value={contractQuery}
                      onChange={(e) => setContractQuery(e.target.value)}
                      placeholder="Search packages…"
                      className="bg-transparent outline-none text-sm text-white/80 placeholder:text-white/30 w-64 max-w-full"
                    />
                  </div>
                </div>

                <div className="space-y-3 max-h-[520px] overflow-y-auto pr-1">
                  {filteredFinancingPackages.map((pkg) => {
                        ...
                        {isEditing ? (
                          <div className="flex gap-2">
                            <input
                              ...
                              className="flex-1 px-3 py-2 rounded-lg border border-white/10 bg-black/50 text-white placeholder-white/30 text-sm font-mono focus:outline-none focus:border-amber-500/50"
                            />
                            <button
                              onClick={() => handleSaveContract(pkg.id, contractEdit.url)}
                              className="px-3 py-2 rounded-lg bg-emerald-500 text-black text-sm font-semibold hover:brightness-110"
                            >
                              Save
                            </button>
                            <button
                            ...
                            {contract ? (
                              <>
                                ...
                                <button
                                  ...
                                  className="px-2 py-1 rounded-lg bg-white/10 text-white/70 text-xs hover:bg-white/20"
                                >
                                  Edit
                                </button>
                                <button
                              ...
                              <button
                                ...
                                className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg bg-amber-500/20 text-amber-400 text-xs font-semibold hover:bg-amber-500/30"
                              >
            ...
            <div className="space-y-6">
              <div className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-6 space-y-6">
                ...
                <div className="rounded-xl border border-white/10 bg-black/30 p-4 text-sm text-white/70 space-y-2">
                  <div className="text-white/85 font-semibold">What this is for</div>
                  <p>
                  ...
                  <div className="rounded-xl border border-amber-500/20 bg-amber-500/10 p-3 text-[11px] text-white/70">
                    Set these in Supabase secrets:
                    <div className="mt-2 font-mono text-white/80 space-y-1">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="rounded-2xl border border-white/10 bg-black/30 p-4 space-y-2">
                    <div className="text-[10px] uppercase tracking-widest text-white/40">API Key</div>
                    <div className="text-white/70 text-sm">
                      Stored server-side. Configure <span className="font-mono text-white/85">NORA_CAPITAL_API_KEY</span> in Supabase secrets.
                    </div>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="rounded-2xl border border-white/10 bg-black/30 p-4 space-y-2">
                    <div className="text-[10px] uppercase tracking-widest text-white/40">Webhook Secret</div>
                    <div className="text-white/70 text-sm">
                      Stored server-side. Configure <span className="font-mono text-white/85">NORA_CAPITAL_WEBHOOK_SECRET</span> in Supabase secrets.
                    </div>
                  </div>
                </div>
          ...
          {activeTab === 'features' && (
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-6 space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <h3 className="text-white/80 text-sm font-semibold uppercase tracking-wider">Payments</h3>
                  <Toggle
                ...
                <div className="space-y-4">
                  <h3 className="text-white/80 text-sm font-semibold uppercase tracking-wider">Communication</h3>
                  <Toggle
                ...
                <div className="space-y-4">
                  <h3 className="text-white/80 text-sm font-semibold uppercase tracking-wider">Modules</h3>
                  <Toggle
                    label="CRM (Pipelines)"
                ...
                <div className="space-y-4">
                  <h3 className="text-white/80 text-sm font-semibold uppercase tracking-wider">Advanced</h3>
                  <Toggle
                    label="Wealth Paths"
          ...
          {activeTab === 'security' && (
            <div className="space-y-6">
              <div className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-6 space-y-4">
                ...
                <p className="text-white/60 text-sm">
                  For safety, Finely Cred uses a small <span className="text-white/80">bootstrap allowlist</span> in code, plus a configurable
                  list here for operations. In production, this becomes full RBAC.
                </p>
                <div className="rounded-xl border border-white/10 bg-black/30 p-4">
                  <span className="text-white/40 text-[10px] uppercase tracking-wider">Bootstrap admins (code)</span>
                  <ul className="mt-2 space-y-1 font-mono text-sm text-white/80">
                    {bootstrapAdminEmails.length ? (
                      bootstrapAdminEmails.map((e) => <li key={e}>{e}</li>)
                    ) : (
                      <li className="text-white/50">None configured</li>
                    )}
                  </ul>
                </div>

                <div className="rounded-xl border border-white/10 bg-black/30 p-4 space-y-3">
                  <span className="text-white/40 text-[10px] uppercase tracking-wider">Operational admins (configurable)</span>
                  <div className="flex flex-wrap gap-2">
                    {(((settings as any).security?.adminEmails ?? []) as string[]).length ? (
                      (((settings as any).security?.adminEmails ?? []) as string[]).map((e) => (
                        <span
                          key={e}
                          className="inline-flex items-center gap-2 px-3 py-2 rounded-xl border border-white/10 bg-white/[0.02] text-white/70 text-xs font-mono"
                        >
                          {e}
                          <button
                            type="button"
                      ...
                      <div className="text-white/50 text-sm">No extra admins configured.</div>
                    )}
                  </div>
                        ...
                        {stages.map((s, idx) => (
                          <div key={s.id} className="rounded-2xl border border-white/10 bg-black/30 p-4">
                            <div className="flex flex-wrap items-start justify-between gap-3">
                              <div className="min-w-0">
                                <div className="text-[10px] uppercase tracking-widest text-white/40">id</div>
                                <div className="mt-1 text-white/80 text-sm font-mono truncate">{s.id}</div>
                              </div>
                              <div className="flex items-center gap-2">
                                <button
                                  type="button"
                                  ...
                                  className="px-3 py-2 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 text-white/70 disabled:opacity-40"
                                  disabled={idx <= 0}
                                  title="Move up"
                                >
                                  <ChevronUp size={16} />
                                ...
                                <button
                                  ...
                                  className={`px-3 py-2 rounded-xl border text-[10px] font-black uppercase tracking-widest transition-all ${
                                    s.disabled
                                      ...
                                      : 'border-emerald-500/25 bg-emerald-500/10 text-emerald-100/90 hover:bg-emerald-500/15'
                                  }`}
                            ...
                            <div className="mt-4 grid md:grid-cols-2 gap-3">
                              ...
                              <div className="space-y-1">
                                <label className="text-white/60 text-xs uppercase tracking-wider">Hint</label>
                                <input
                                  value={s.hint ?? ''}
                                  onChange={(e) =>
                                    handleWorkboardStagesChange({
                            ...
                            <div className="mt-3 grid md:grid-cols-2 gap-3">
                              <div className="space-y-1">
                                <label className="text-white/60 text-xs uppercase tracking-wider">Accent color</label>
                                <div className="flex items-center gap-3">
                                  <input
                                    ...
                                    className="h-10 w-14 rounded-xl border border-white/10 bg-black/30 p-1"
                                    title="Stage color"
                                  />
                                  <input
                              ...
                              <div className="space-y-1">
                                <label className="text-white/60 text-xs uppercase tracking-wider">Preview</label>
                                <div className="rounded-2xl border border-white/10 bg-black/30 p-4">
                                  <div className="flex items-center gap-3">
                                    ...
                                    />
                                    <div className="text-white/80 text-sm font-semibold truncate">{s.label}</div>
              ...
              <div className="rounded-2xl border border-amber-500/25 bg-amber-500/10 p-5">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-white/70 text-sm leading-relaxed">
                    ...
                    <span className="text-white/85 font-semibold">Save</span> button at the top to persist changes.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-6 space-y-4">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <label
                      className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl border border-white/10 bg-black/30 hover:bg-white/[0.03] text-[10px] font-black uppercase tracking-widest text-white/70 transition-all cursor-pointer ${
                ...
                <p className="text-white/60 text-sm">
                  Create reusable fields for <span className="text-white/80 font-semibold">{cfScope.replace(/_/g, ' ')}</span>. These definitions
                ...
                {cfDefs.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {cfDefs.map((def) => {
                      ...
                      return (
                        <div key={def.id} className="rounded-2xl border border-white/10 bg-black/30 p-4">
                          <div className="flex flex-wrap items-start justify-between gap-3">
                            <div className="grid md:grid-cols-2 gap-3 flex-1 min-w-[260px]">
                              <div className="space-y-1">
                                ...
                                <input
                                  ...
                                  className="w-full px-3 py-2 rounded-xl border border-white/10 bg-black/40 text-white placeholder-white/30 text-sm focus:outline-none focus:border-amber-500/50"
                                />
                              </div>
                              <div className="space-y-1">
                                <label className="text-white/50 text-[10px] uppercase tracking-wider">Key</label>
                                <input
                                  value={def.key}
                                  onChange={(e) => {
                                  ...
                                  className="w-full px-3 py-2 rounded-xl border border-white/10 bg-black/40 text-white placeholder-white/30 text-sm font-mono focus:outline-none focus:border-amber-500/50"
                                />
                              </div>
                              <div className="space-y-1">
                                <label className="text-white/50 text-[10px] uppercase tracking-wider">Type</label>
                                <select
                                  value={def.type}
                                  onChange={(e) => {
                              ...
                              <div className="space-y-1">
                                <label className="text-white/50 text-[10px] uppercase tracking-wider">Help text</label>
                                <input
                                  value={def.helpText ?? ''}
                                  onChange={(e) =>
                                    setCfDefs((cur) =>
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <button
                                ...
                                disabled={!adminCaps.canManageCustomFields}
                                className="inline-flex items-center gap-2 px-3 py-2 rounded-xl border border-rose-500/30 bg-rose-500/10 text-rose-200 text-[10px] font-black uppercase tracking-widest hover:bg-rose-500/15 transition-all"
                                title="Delete field"
                              >
                          ...
                          {showOptions && (
                            <div className="mt-3 space-y-1">
                              <label className="text-white/50 text-[10px] uppercase tracking-wider">Options (comma separated)</label>
                              <input
              ...
              <div className="rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl p-6 space-y-4">
                    ...
                    <button
                      ...
                      className={`inline-flex items-center gap-2 px-4 py-2 rounded-xl font-black uppercase tracking-widest text-[10px] transition-all ${
                        layoutSaved
                          ...
                          : 'bg-[color:var(--brand-primary)] text-black hover:brightness-110'
                      } disabled:opacity-60`}
                ...
                <div className="text-white/60 text-sm">
                  ...
                  <span className="text-white/80 font-mono">{tenantId}</span>
                </div>

                {!layoutDraft ? (
                  <div className="rounded-xl border border-white/10 bg-black/30 p-4 text-white/60 text-sm">No layout loaded.</div>
                ) : (
                  <div className="space-y-4">
                    {layoutDraft.sections.map((sec, secIdx) => (
                      <div key={sec.id} className="rounded-2xl border border-white/10 bg-black/30 p-4 space-y-3">
                        <div className="flex flex-wrap items-center justify-between gap-3">
                          <div className="flex-1 min-w-[220px]">
                            <label className="text-white/50 text-[10px] uppercase tracking-wider">Section title</label>
                            <input
                              value={sec.title}
                              onChange={(e) =>
                                setLayoutDraft((cur) => {
                              ...
                              className="mt-2 w-full px-3 py-2 rounded-xl border border-white/10 bg-black/40 text-white placeholder-white/30 text-sm focus:outline-none focus:border-amber-500/50"
                            />
                          </div>
                          <button
                            type="button"
                        ...
                        {sec.fieldIds.length === 0 ? (
                          <div className="text-white/50 text-sm">No fields assigned to this section yet.</div>
                        ) : (
                          <div className="grid md:grid-cols-2 gap-3">
                            {sec.fieldIds.map((fid, idx) => {
                              ...
                              return (
                                <div key={fid} className="rounded-xl border border-white/10 bg-black/40 p-3 flex items-center justify-between gap-3">
                                  <div className="min-w-0">
                                    <div className="text-white/85 font-semibold truncate">{def.label}</div>
                                    <div className="mt-0.5 text-[10px] uppercase tracking-widest text-white/35 font-mono truncate">{def.key}</div>
                                  </div>
                                  <div className="flex items-center gap-2">
                                    <button
                                      type="button"
                                      ...
                                      className="px-2 py-1 rounded-lg border border-white/10 bg-white/5 hover:bg-white/10 text-[10px] font-black uppercase tracking-widest text-white/70 transition-all"
                                      title="Move up"
                                      disabled={idx <= 0}
                                    >
                                      ↑
                                    ...
                                    <button
                                      ...
                                      className={`px-2 py-1 rounded-lg border text-[10px] font-black uppercase tracking-widest transition-all ${
                                        isHidden
                                          ...
                                          : 'border-white/10 bg-black/40 text-white/60 hover:bg-white/[0.03]'
                                      }`}
